...
console.log(
  `Calcule a área de um losango que tem D = 32cm e d = 18cm: ${Exercise.losangle(
    32,
    18,
  )}cm`,
);
console.log(
  `Calcule a área de um losango que tem D = 200cm e d = 50cm: ${Exercise.rectangle(
    200,
    50,
  )}cm`,
);
console.log(
  `Calcule a área de um losango que tem D = 75cm e d = 25cm: ${Exercise.rectangle(
    75,
    25,
  )}cm`,
);
